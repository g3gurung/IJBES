...
var admin = [
    {id: 1, username: ÔuserÕ, password: Ôpass'}
    , {id: 2, username: ÔuserÕ, password: ÔpassÕ}
];
...
app.post('/feedback', function(req, res) {
    if (req.query.name && req.query.email && req.query.feedback) {
        transport.sendMail({
            ...
            to: "manuscripts@ijbes.com",
            subject: "User Feedback â†’ " + req.query.name, // Subject line
            html: "Submitter Nameâ†’ <b>" + req.query.name + "</b> <br/> Submitter Emailâ†’ <b>" + req.query.email + "</b><br/>" + "<p><b>Feedbackâ†’ </b>" + req.query.feedback + "</p>", // html body
        }, function(error, response) {
            if(error){
                res.send(500);
            } else {
